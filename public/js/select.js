...
// Adding/removing host button after private
option[1].addEventListener('change', ()=>{
    ...
    label1.innerHTML = `Host<input type="radio" name="check" value=${roomid} required> <i class="fa fa-check" aria-hidden="true"></i>`
    label2.innerHTML = `<input type="radio" name="check" value="no" required> <i class="fa fa-times" aria-hidden="true"></i>`
